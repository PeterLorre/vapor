...
- moving vapor ahoy function to main functions file
...
- removed "Powered by Wordpress & vapor" from footer, because let's face it: we all delete this anyway.
...
- removed default "vapor" text in footer if you don't have a menu
...
- added vapor body class depending on what browser
...
- added post formats to vapor.php core
...
- fixed error in vapor.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the vapor file so it's easier to see what's being
	called.
